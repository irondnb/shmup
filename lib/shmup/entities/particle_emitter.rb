  ...
  module Entities
    class ParticleEmitter < Core::Component
      ...
      def initialize(object, object_pool)
        ...
        @object = object
        @particles = []
        @sprites = %w[cockpit engine_01 engine_02 gun_01 gun_02 gun_03 wing_01 wing_02 wing_03].collect {|s| Gosu::Image.new(Utils.asset_path("/sprites/parts/#{s}.png"), tileable: false)}
      end
